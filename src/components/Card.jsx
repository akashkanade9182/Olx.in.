...
const Card=({id,image,title,price,location,handleClick})=>{

    return (
        <GridItem onClick={()=>handleClick(id)} padding={"10px 10px"}  boxShadow={"rgba(0, 0, 0, 0.35) 0px 5px 15px;"}  height="auto" width="250px">
            <VStack>
            <HStack>
            <Image src={image} alt="" />
            </HStack>
