...
const getcars=()=>{
    return axios.get(`http://localhost:3000/post?id_gte=4&id_lte=7`)
}
const getmotarcycle=()=>{
    return axios.get(`http://localhost:3000/post?id_gte=18&id_lte=21`)
}
const getMobile=()=>{
    return axios.get(`http://localhost:3000/post?id_gte=30&id_lte=33`)
}
